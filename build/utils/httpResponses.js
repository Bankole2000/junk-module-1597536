...
Object.keys(StatusTypes).forEach(status => {
    httpResponses[status] = ({ message = httpStatus[status].message, data = {}, success = true, error = null, errMessage = null, fix = httpStatus[status].statusCode < 300 ? 'please contact support' : null, newAccessToken = null }) => {
